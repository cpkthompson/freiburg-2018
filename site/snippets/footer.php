  ...
  <div class="wrf">
    ...
    <nav class="n">
      <ul>
        ...
        <li class="k"><a href="http://getkirby.com">Made with Kirby and &hearts;</a></li>
...
<script>if('serviceWorker' in navigator){navigator.serviceWorker.register('/service-worker.js',{scope:'https://smashingconf.com/ny-2019/'});}</script>
</body>
</html>
